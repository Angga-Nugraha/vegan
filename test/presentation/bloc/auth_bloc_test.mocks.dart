...
// in vegan/test/presentation/bloc/auth_bloc_test.dart.
...
class MockLogin extends _i1.Mock implements _i4.Login {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.Auth>> execute(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLogout extends _i1.Mock implements _i8.Logout {
  MockLogout() {
    _i1.throwOnMissingStub(this);
  }
